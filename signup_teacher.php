...
//btnSignUpTeacher
if (isset($_POST['btnSignUpTeacher'])) {
    ...
    $sql_signUp = "update teacher set username = '$username', password = '$password' where teacherCode = '$teacherCode'";
    $q_signUp = mysql_query($sql_signUp,$connection);
    if(!$q_signUp){
        echo die(mysql_error());
    }else{
        header("Location: teacher/teacher_upload_photo.php?teacherCode='$teacherCode'");
    }
}
?>
<html>
    ...
    <div class="row">
        <div class="col-md-offset-7 col-md-4 form-login">
            ...
            <form role="form" action="" method="post">
                <h3 class="text-center text-primary"><span class="glyphicon glyphicon-lock"></span> Sign Up as Teacher</h3>
                <hr>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Teacher Code" name="teacherCode">
                </div>
                <div class="form-group">
                ...
                <input type="submit" class="btn btn-primary" value="Sign Up" name="btnSignUpTeacher">
